...
#1030#MENU_EXTRAS="Battery.menu Clock.menu"
#1030#add_files_at_path "${MENU_EXTRAS}" "/System/Library/CoreServices/Menu Extras"
#1030#cp "${SYSBUILDER_FOLDER}"/common/com.apple.menuextra.textinput.plist "${TMP_MOUNT_PATH}"/var/root/Library/Preferences/
#1030#chmod 644        "${TMP_MOUNT_PATH}"/Library/Preferences/com.apple.menuextra.textinput.plist
#1030#chown root:wheel "${TMP_MOUNT_PATH}"/Library/Preferences/com.apple.menuextra.textinput.plist
#1030#cp "${SYSBUILDER_FOLDER}"/common/com.apple.systemuiserver.plist "${TMP_MOUNT_PATH}"/var/root/Library/Preferences/
#1030#chmod 644        "${TMP_MOUNT_PATH}"/Library/Preferences/com.apple.systemuiserver.plist
...
rm -f "${TMP_MOUNT_PATH}"/System/Library/LaunchDaemons/com.apple.InstallerProgress.plist
#1030#cp -R "${SYS_VERS_FOLDER}"/LaunchDaemons/* "${TMP_MOUNT_PATH}"/System/Library/LaunchDaemons/ 2>&1
#1030#chmod 644 "${TMP_MOUNT_PATH}"/System/Library/LaunchDaemons/* 2>&1

#1030#cp -R "${SYS_VERS_FOLDER}"/LaunchAgents/* "${TMP_MOUNT_PATH}"/System/Library/LaunchAgents/ 2>&1
#1030#chmod 644 "${TMP_MOUNT_PATH}"/System/Library/LaunchAgents/* 2>&1
...
#1030#cp "${SYS_VERS_FOLDER}"/etc/rc.cdrom "${TMP_MOUNT_PATH}"/etc/rc.cdrom 2>&1
#1030#cp "${SYS_VERS_FOLDER}"/etc/nsmb.conf "${TMP_MOUNT_PATH}"/etc/nsmb.conf 2>&1
...
#1030#chmod 755 "${TMP_MOUNT_PATH}"/etc/rc.cdrom 2>&1
#1030#chmod 644 "${TMP_MOUNT_PATH}"/etc/nsmb.conf 2>&1
...
#1030#rm -r  "${TMP_MOUNT_PATH}"/System/Library/LaunchDaemons/com.apple.locationd.plist
#1030#rm -r  "${TMP_MOUNT_PATH}"/System/Library/LaunchDaemons/com.apple.lsd.plist
#1030#rm -r  "${TMP_MOUNT_PATH}"/System/Library/LaunchDaemons/com.apple.ocspd.plist
#1030#rm -r  "${TMP_MOUNT_PATH}"/System/Library/LaunchDaemons/com.apple.tccd.system.plist
#1030#rm -r  "${TMP_MOUNT_PATH}"/System/Library/LaunchDaemons/org.ntp.sntp.plist
